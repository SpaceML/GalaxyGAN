...
$shell_command = "export CUDNN_PATH=/usr/local/cuda/lib64/libcudnn.so && export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/torch/install/lib:/usr/local/cuda/lib64 && DATA_ROOT=".$processDir." name=001002_2.5_5.0 which_direction=BtoA phase=test display=0 gpu=1 checkpoints_dir=/mnt/ds3lab/roou_v2_checkpoint/ results_dir=demo_response/ /usr/local/torch/install/bin/th /mnt/ds3lab/astronomy/pix2pix/test.lua > /tmp/th4.log 2>&1";
$op = shell_exec($shell_command);
